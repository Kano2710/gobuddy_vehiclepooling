				...
				<div class="sign-in-form">
					...
					<div>
						...
						<div class="log-input">
							...
							<button type="submit" class="btn btn-default w3ls-button" id="login_btn"
								onclick="myFunction()">Login</button>
							<button type="submit" class="btn btn-default w3ls-button"><a href=create.php> Create an
									account</a></button>
